...
20/08/2024	1.0.0.4		DPR, Skyline	Upgrade nuget interapp
****************************************************************************
*/
...
public class Script
{
	...
	public void Run(Engine engine)
	{
		...
		var pairDetails = engine.GetScriptParam("CollectorList").Value;

		var pairList = JsonConvert.DeserializeObject<List<string>>(pairDetails);
		...
		foreach (var pair in pairList)
		{
			...
			var dmaId = split[0];
			var collectorId = split[1];
			command.Source = new Source("Back-End GPON");
